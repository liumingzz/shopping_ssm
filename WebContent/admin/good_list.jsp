...
<div class="container">
    ...
    <div >
        <form method="get" action="${pageContext.request.contextPath}/admin/goodList?type=${type}" style="display:inline;">
            <span class="input_span">商品ID：<input name="gid" type="number" class="input-group" style="display: inline"></span>
            <span class="input_span" style="margin-left: 12px">商品名称：<input name="goodname" type="text" class="input-group" style="display: inline"></span>
            <span><input type="submit" style="margin-left: 12px" value="搜索" class="btn btn-success btn-sm"></span>
        </form>
        <a class="btn btn-warning" style="margin-left: 40%" href="goodAdd" >添加商品</a>
    </div>
    </br>
    ...
    <ul role="tablist" class="nav nav-tabs">
        <li
                <c:if test='${type==0}'>class="active"</c:if> role="presentation"><a href="goodList">全部商品</a></li>
        <li
