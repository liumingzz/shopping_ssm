...
<div id="main">
    ...
    <div>
        <img src="img/payok.jpg" width="200px">
        <span style="font-size: 40px;">支付成功</span>
        <a href="order">
            <p style="width: 130px;background: #FF712B;border-radius: 6px;color: #fff;font-size: 18px;text-align: center;line-height: 48px;margin-left: 210px;">
                查看我的订单</p>
        </a>
