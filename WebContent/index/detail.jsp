    ...
    <div id="evaluates">
        <div class="goodsmain">
            <div class="goodstit">
                ...
                <div class="gmain">
                    <div class="main xq">
                        <c:if test="${evaluates.size()==0}"><center>暂无评论</center></c:if>
                        <c:forEach items="${evaluates}" var="evaluate">
                            <div id="evaluates_content">
                                <div id="userInfo" style="font-weight: bold">用户名：${evaluate.user.username}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    评论时间： ${evaluate.getDateString()}</div>
                                评论内容：</br>
                                ${evaluate.content}
                            </div>
                        </c:forEach>
